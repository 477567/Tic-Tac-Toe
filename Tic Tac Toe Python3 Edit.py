...
def get_text(i, j, gb, l1, l2):
	...
	if winner(board, "X"):
		gb.destroy()
		box = messagebox.showinfo("Winner", "Congrats!Player 1 won the game")
	elif winner(board, "O"):
		gb.destroy()
		box = messagebox.showinfo("Winner", "Congrats!Player 2 won the game")
	elif(isfull()):
		gb.destroy()
...
def get_text_pc(i, j, gb, l1, l2):
	...
	if winner(board, "X"):
		gb.destroy()
		x = False
		box = messagebox.showinfo("Winner", "Player won the game")
	elif winner(board, "O"):
		gb.destroy()
		x = False
		box = messagebox.showinfo("Winner", "Computer won the game")
	elif(isfull()):
		gb.destroy()
		x = False
		box = messagebox.showinfo("Tie Game", "Tie Game")
